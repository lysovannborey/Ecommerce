...
$module_constant = 'RESPONSIVE_SHEFFIELD_BLUE_VERSION'; // This should be a UNIQUE name followed by _VERSION for convention
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/responsive_sheffield_blue'; // This is the directory your installer is in, usually this is lower case
$module_name = "Responsive Sheffield Blue"; // This should be a plain English or Other in a user friendly way
$zencart_com_plugin_id = 1744; // from zencart.com plugins - Leave Zero not to check
...
if ($zc150) { // continue Zen Cart 1.5.0
  $admin_page = 'configRESPONSIVE_SHEFFIELD_BLUE';
  ...
  if (!zen_page_key_exists($admin_page)) {
    if ((int)$configuration_group_id > 0) {
      ...
      $messageStack->add('Enabled Responsive Sheffield Blue Configuration Menu.', 'success');
    }
  }
}
