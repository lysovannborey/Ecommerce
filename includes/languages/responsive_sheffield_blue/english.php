 ...
 * Modified by Anne (Picaflor-Azul.com) Responsive Sheffield Blue v2.0
 */
...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_blank">' . STORE_NAME . '</a>.  Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart</a>.  <a href="http://www.picaflor-azul.com" target="_blank">Mobile Friendly Zen cart templates</a> by Picaflor Azul.');
...
// whats_new box text in sideboxes/whats_new.php
  define('BOX_HEADING_WHATS_NEW', 'Newest');
